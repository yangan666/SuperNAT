-- 用户表
DELETE FROM `user`;
INSERT INTO `user` (`user_id`, `user_name`, `password`, `wechat`, `email`, `tel`, `is_disabled`, `is_admin`, `role_id`, `create_time`, `login_times`, `last_login_time`) VALUES ('dd7e6727968544298e016f7f246f879d', 'admin', '3A03EDF0A917A6A757194FCF4D429A5E', NULL, 'admin@qq.com', NULL, '\0', '', '2c033d577bea44aa825ffae125c7367e', now(), 0, NULL);
